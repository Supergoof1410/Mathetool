...
///
/// # Parameter
/// - `variables_array_coeffizenten`: Ein Array mit genau 3 Werten (f64), die die Koeffizienten
...
/// - Komplexe Zahlen (imaginäre Lösungen) werden unterstützt.
///
/// # Hinweis
...
pub fn midnight_formula(variables_array_coeffizenten: &[f64; 3]) {
    ...
    let radikand: f64 = (variables_array_coeffizenten[1] * variables_array_coeffizenten[1]) - 4.0 * variables_array_coeffizenten[0]*variables_array_coeffizenten[2];
    ...
    if radikand < 0.0 {
        ...
        result = (-(variables_array_coeffizenten[1]))/(2.0 * variables_array_coeffizenten[0]);
        let result_imag: f64 = radikand_negotation.sqrt() / (2.0 * variables_array_coeffizenten[0]);
    ...
    // Berechnung nur wenn die Diskriminante = 0 ist
        ...
        result = (-(variables_array_coeffizenten[1])-radikand.sqrt())/(2.0 * variables_array_coeffizenten[0]);
